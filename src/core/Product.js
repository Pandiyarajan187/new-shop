   ...
   const { relatedProducts, loadProduct, productsLoad, getRelatedProducts } = useContext(authContext)
    ...
    <div class="section">
        <div class="container">
            <div class="main main-raised main-product">
                <div class="row">
                    <div class="col-md-6 col-sm-6 text-center">
                        <img src={`http://localhost:8000/api/product/photo/${product._id}`} alt={product._id} class="img-raised rounded" style={{ height: '250px' }}/> 
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Stock</th>
                                                        <td>{showStock(product.quantity)}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Price</th>
            ...
            {related.length > 0 && <div class="related-products">
                <h3 class="title text-center">You may also be interested in:</h3>
                <div class="row">
                { related.map((value, key) => <div className="col-md-4 pb-4"><Card key={key} product={value} /></div> ) }
                </div>
            </div>}
        </div>
    </div>
       {/*  <div className="row">
            ...
            <div className="col-md-4">
                ...
                { related.map((value, key) => <div className="col-md-12 pb-4"><Card key={key} product={value} /></div> ) }
            </div>
            </div>*/}
    </div>
    )
